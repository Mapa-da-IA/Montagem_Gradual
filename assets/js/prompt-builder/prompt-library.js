...
const framingLabelsFromAudit = [
  ...
  'Consistência da imagem de referência',
  'Fachada frontal ampla',
  'Hero shot em ângulo baixo',
  'Exterior médio natural',
  'Fachada em 45 graus',
  'Fachada cinematográfica baixa',
  'Exterior em ângulo alto',
  'Fachada vista de longe',
  'Fachada simétrica central',
  'Vista três quartos externa',
  'Fachada ampla cinematográfica',
  'Exterior teleobjetiva',
  'Detalhe arquitetônico externo',
  ...
  'Elevação frontal aérea',
  'Drone descendente cinematográfico',
  ...
  'Interior espaçoso amplo',
  'Interior de canto equilibrado',
  'Close-up de acabamento',
  'Área de design refinada',
  'Texturas internas com 70mm',
  'Lifestyle arquitetônico sem pessoas',
  'Composição vertical interna',
  'Composição horizontal interna',
  'Entrada de luz natural',
  'Pé-direito e espaço vertical',
  'Textura do piso e profundidade',
  'Luminárias e materiais',
...
function framingCategory(label) {
  ...
  if (/full|corpo|ampla|wide|a[eé]reo|drone|establishing|exterior|fachada|interior amplo/i.test(label)) return 'plano-aberto';
  ...
  if (/symmetrical|sim[eé]trica|central|centered/i.test(label)) return 'simetrico';
...
function framingPrompt(label) {
  ...
  if (/wide|ampla|a[eé]reo|drone|establishing|exterior|fachada|interior/i.test(label)) return 'wide environmental framing, clear spatial context, balanced composition lines';
  if (/symmetrical|sim[eé]trica|central|centered/i.test(label)) return 'centered symmetrical framing, balanced visual weight, clean alignment';
